...
#define TUYA_OPENSDK_UUID    "uuidd76cc788536c93f3"             // Please change the correct uuid
#define TUYA_OPENSDK_AUTHKEY "YmDz8PhJAxqaOvA2rtzyLP8MXibOEsty" // Please change the correct authkey
